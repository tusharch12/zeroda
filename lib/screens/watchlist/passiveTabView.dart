...
class PassiveTabContent extends StatefulWidget {
  final String title;
  const PassiveTabContent({super.key, required this.title});

  @override
  State<PassiveTabContent> createState() => _PassiveTabContentState();
}

class _PassiveTabContentState extends State<PassiveTabContent> {
